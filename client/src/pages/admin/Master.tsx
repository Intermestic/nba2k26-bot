        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Master Team Management</h1>
                <p className="text-slate-400 mt-1">Admin-only player team assignment</p>
              </div>
            </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-slate-700 hover:bg-slate-800/50">
                      ...
                      <TableHead className="text-slate-300 text-center">Overall</TableHead>
                      <TableHead className="text-slate-300">Current Team</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
