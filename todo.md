...
## Discord Bot Refactoring (Dec 27, 2024)

### Core Features to Keep
- [x] FA (Free Agency) system with bidding
- [x] Trade voting and approval
- [x] Team role management
- [x] Cap violation monitoring
- [x] Custom commands
- [x] Roster auto-updates

### Features to Remove
- [x] Remove activity booster system (activity-booster-command, activity-booster-parser, analytics-tracker)
- [x] Remove welcome/goodbye handler
- [x] Remove reaction role handler
- [x] Remove badge lookup handler
- [x] Remove scheduled message handler
- [x] Remove logging system (logging-system, bot-logger)
- [x] Remove FA status hourly updates
- [x] Remove FA window close summaries
- [x] Remove outbid notifications (kept in streamlined version for FA bidding)
- [x] Remove team channel manager
- [x] Remove team role logger
- [x] Remove team welcome messages
- [x] Remove bot monitoring service

### Code Cleanup
- [x] Strip discord-bot.ts down to core functionality only
- [x] Remove all unused event listeners
- [x] Remove all unused command handlers
- [x] Remove all unused initialization code from clientReady
- [x] Simplify error handling and reduce complexity
- [x] Add better connection retry logic
- [x] Add heartbeat monitoring for reliability
- [x] Test bot startup and shutdown

### Reliability Improvements
- [x] Reduce lock refresh complexity
- [x] Simplify database connection handling
